        ...
        <Container component="main" maxWidth="xs">
            <div className={classes.paper}>
                <form id="form" className={classes.form} label="Cadastrar Aluno">
                    <Typography variant="h5" className={classes.titulo}>Atualizar Cadastro</Typography>
                        ...
                        <Button type="submit" fullWidth variant="contained" color="primary" style={{padding: '3%'}} className={classes.submit} >Atualizar</Button>
                </form>
            </div>
        </Container>
        </>
